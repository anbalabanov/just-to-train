...
function Header() {
    ...
    const isDarkTheme = useAppSelector((state) => state.appReducer.app.isDarkTheme)
            ...
            <div className="max-w-8xl mx-auto">
                <div
                    ...
                    <div className="relative flex items-center text-sm leading-6 font-semibold text-slate-700 dark:text-slate-200">
                        <a
                        className="mr-3 flex-none w-[2.0625rem] overflow-hidden md:w-auto" href="/">
                        <span className="hover:text-sky-500 dark:hover:text-sky-400">World Radio Online</span>
                    </a>
                        <div className="relative hidden lg:flex items-center ml-auto">
                            <nav className="text-sm leading-6 font-semibold text-slate-700 dark:text-slate-200">
                                <ul className="flex space-x-8">
                                    <li><a className="hover:text-sky-500 dark:hover:text-sky-400"
                                           href="#">Page 1</a></li>
                                    <li><a href="#"
                                           className="hover:text-sky-500 dark:hover:text-sky-400">Page 2</a></li>
                                    <li><a className="hover:text-sky-500 dark:hover:text-sky-400" href="#">Page 3</a>
                                    </li>
                                    <li><a className="hover:text-sky-500 dark:hover:text-sky-400"
                                           href="#">Page 4</a></li>
                                </ul>
                            ...
                            <div
                                ...
                                <label className="sr-only" id="headlessui-listbox-label-:Rpkcr6:"
                                       data-headlessui-state="">Theme</label>
                                <button
                                    onClick={() => dispatch(toggleThemeMode())}
                                    type="button" id="headlessui-listbox-button-:R19kcr6:" aria-haspopup="true"
                                    ...
                                    <span className="dark:hidden"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2"
                                ...
                                <a href="https://github.com/tailwindlabs/tailwindcss"
                                   className="ml-6 block text-slate-400 hover:text-slate-500 dark:hover:text-slate-300"><span
                                    className="sr-only">Login</span>
                ...
                <div
                    className="flex items-center p-4 border-b border-slate-900/10 lg:hidden dark:border-slate-50/[0.06]">
                    <button type="button"
                            className="text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300">
                        <span className="sr-only">Navigation</span>
                        <svg width="24" height="24">
                            <path d="M5 6h14M5 12h14M5 18h14" fill="none" stroke="currentColor" strokeWidth="2"
                                  strokeLinecap="round"></path>
                        </svg>
                    </button>
                    <ol className="ml-4 flex text-sm leading-6 whitespace-nowrap min-w-0">
                        <li className="flex items-center">Core Concepts
                            <svg width="3" height="6" aria-hidden="true"
                                 className="mx-3 overflow-visible text-slate-400">
                                <path d="M0 0L3 3L0 6" fill="none" stroke="currentColor" strokeWidth="1.5"
                                      strokeLinecap="round"></path>
                            </svg>
                        </li>
                        <li className="font-semibold text-slate-900 truncate dark:text-slate-200">Dark Mode</li>
                    </ol>
                </div>
            </div>
        </header>
