        ...
        <footer className="fixed inset-x-0 bottom-0 bg-no-repeat dark:bg-slate-900/75">
            <div className="shadow-lg rounded-lg">
                <div className="w-full p-6">
                    <div
                        className="grid grid-cols-2 items-center justify-items-center content-center md:grid-cols-3 h-full">
                        ...
                        <div
                            className="justify-self-center p-8 rounded-full bg-red-light shadow-lg cursor-pointer hover:text-sky-500 dark:hover:text-sky-400"
                            onClick={toggle}>
