...
const StationFilter = () => {
    ...
    const dropdownContent = isOpen && (
        <div
            className={"dark:bg-gray-800 dark:text-white bg-white text-gray-800 absolute mt-4 py-2 w-48 border border-gray-300 rounded-lg shadow-lg z-10"}
        >
            ...
            <div className="px-4 py-2 space-y-1">
                {genres.map(({id, name}) => {
                    return                 <label key={id} className="flex items-center">
                        <input
                            type="checkbox"
